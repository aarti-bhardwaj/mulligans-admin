...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'asking_price' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'product_description' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-06-18 07:38:27',
                'modified' => '2018-06-18 07:38:27'
            ],
        ];
        parent::init();
    }
